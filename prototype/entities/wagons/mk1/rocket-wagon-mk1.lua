...
({
	{
		...
		icon = "__Armored-train_Nayfall_Fixes__/assets/rocket-platform-mk1/rocket-platform-mk1-icon.png",
		icon_size = 64,
		icon_mipmaps = 4,
		subgroup = "transport",
...
-- Icon
l_rocket_wagon_mk1.icon = "__Armored-train_Nayfall_Fixes__/assets/rocket-platform-mk1/rocket-platform-mk1-icon.png"
	...
	{
		{
			...
			filenames =
			{
				"__Armored-train_Nayfall_Fixes__/assets/rocket-platform-mk1/sprites/platform-mk1-01.png",
				"__Armored-train_Nayfall_Fixes__/assets/rocket-platform-mk1/sprites/platform-mk1-02.png",
				"__Armored-train_Nayfall_Fixes__/assets/rocket-platform-mk1/sprites/platform-mk1-03.png",
				"__Armored-train_Nayfall_Fixes__/assets/rocket-platform-mk1/sprites/platform-mk1-04.png"
			}
		}
	}
}
...
{
	filename =
	"__Armored-train_Nayfall_Fixes__/assets/rocket-platform-mk1/rocket-platform-mk1-selected-minimap-representation.png",
	flags = { "icon" },
	size = { 20, 40 },
	scale = 0.5
}
