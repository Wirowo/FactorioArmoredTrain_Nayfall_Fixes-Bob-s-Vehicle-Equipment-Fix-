	...
	{
		{
			...
			{
				{
					filename = "__Armored-train_Modified__/assets/flamethrower-turret-mk1/sprites/flamethrower-turret-shooting-1.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train_Modified__/assets/flamethrower-turret-mk1/sprites/flamethrower-turret-shooting-2.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train_Modified__/assets/flamethrower-turret-mk1/sprites/flamethrower-turret-shooting-3.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train_Modified__/assets/flamethrower-turret-mk1/sprites/flamethrower-turret-shooting-4.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				}
			}
...
local blank_layers = 
{
	...
	{
		{
			filename = 	"__Armored-train_Modified__/assets/flamethrower-turret-mk1/fakeTransparent.png",
			direction_count = 1,
			height = 16,
			width = 16
		}
