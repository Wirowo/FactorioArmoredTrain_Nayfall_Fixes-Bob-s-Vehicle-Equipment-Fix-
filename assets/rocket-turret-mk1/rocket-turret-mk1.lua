	...
	{
		{
			...
			{
				{
					filename = "__Armored-train_Modified__/assets/rocket-turret-mk1/sprites/rocket-turret-shooting-1.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train_Modified__/assets/rocket-turret-mk1/sprites/rocket-turret-shooting-2.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train_Modified__/assets/rocket-turret-mk1/sprites/rocket-turret-shooting-3.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train_Modified__/assets/rocket-turret-mk1/sprites/rocket-turret-shooting-4.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				}
			}
